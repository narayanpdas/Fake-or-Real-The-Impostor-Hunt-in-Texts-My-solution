...
### My Public Kaggle NoteBook (which just received bronze 🥉 🥲): [Final-Solution-NoteBook](https://www.kaggle.com/code/narayanprasaddas/deberta-large-with-readx-ensemble-model-lb-0-914)
...
### - _BaseLine_ (TF-IDF with logistic Regression):
...
### - _Deberta with Baseline Ensemble (The 25-Day Champion)_:

My best-performing solution for over three weeks was a hybrid blend. By taking a weighted average of the probabilities from the _DeBERTa-with-Pseudo-Labeling model_ and _the Ensemble of Baselines_, I achieved a score of **0.88**. This "best of both worlds" approach proved to be a very powerful strategy.
...
### _DeBERTa with Domain Adaptation_ :
...
### _The Champion with Reinforcement Learning_:
...
### The Below is the sole reason for trying out this RL approach with the _Chapmpion Model_.
...
_The following chart highlights how close the model’s predictions were, with most lying in a narrow band near decision boundaries._
